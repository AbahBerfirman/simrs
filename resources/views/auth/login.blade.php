    ...
    <div class="login-box">
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a href="{{ url('/home') }}" class="h1"><b>{{ config('app.name') }}</b></a>
            </div>
            <div class="card-body">
                ...
                <form method="post" action="{{ url('/login') }}">
                    ...
                    <div class="input-group mb-3">
                        <input id="username" type="username" placeholder="Email or Username" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" required  autofocus>
